...
connect sys/"#Bala1234"@balaproy as sysdba
...
create or replace directory proyecto_final_imagenes_dir
as '/unam-bda/proyecto/scripts/imagenes';
create or replace directory proyecto_final_fragmentos_dir
as '/unam-bda/proyecto/scripts/fragmentos';
create or replace directory proyecto_final_audios_dir
as '/unam-bda/proyecto/scripts/audios';

grant read,write on proyecto_final_audios_dir to developer_m;
grant read,write on proyecto_final_imagenes_dir to developer_m;
grant read,write on proyecto_final_fragmentos_dir to developer_m;
